...
1. Comparte `index.html` con las personas que quieres rastrear
2. La página se ve como una tienda normal de skates
3. Los datos se capturan automáticamente en segundo plano
4. Los datos se guardan en localStorage del navegador

### Para ver los datos capturados:
1. Abre `admin.html` en el MISMO navegador donde se abrió `index.html`
...
**IMPORTANTE:** Los datos se guardan en localStorage, por lo que debes abrir `admin.html` en el mismo navegador y dispositivo donde se capturaron los datos.
